...
<body class="bg-dash bg-cover ">
    ...
    <div class="w-full px-8 md:px-16 xl:px-64">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-16 justify-between py-5 mb-20">
            ...
            <!-- Usuarios -->
            <div class="group h-44 p-5 bg-card-users bg-cover bg-center rounded-3xl transition duration-500 ease-in-out">
                <div class="bg-gray-400 bg-opacity-25 w-16 h-16 rounded-2xl py-3 mb-4 group-hover:bg-purple-900 transition duration-500 ease-in-out">
                    <img src="{{ asset('img/icon-user.png') }}" alt="" class="w-10 mx-auto">
                </div>
                <h1 class="text-white font-bold text-2xl">{{ $users->count() }} usuarios</h1>
                <a href="{{ route('admin-users') }}" class="text-white font-light hover:text-purple-400 transition duration-500 ease-in-out">Ver usuarios</a>
            </div>

            <!-- Equipos -->
            <div class="group h-44 p-5 bg-card-teams bg-cover bg-center rounded-3xl transition duration-500 ease-in-out">
                <div class="bg-gray-400 bg-opacity-25 w-16 h-16 rounded-2xl py-3 mb-4 group-hover:bg-pink-800 transition duration-500 ease-in-out">
                    <img src="{{ asset('img/icon-team.png') }}" alt="" class="w-10 mx-auto">
                </div>
                <h1 class="text-white font-bold text-2xl">{{ $teams2->count() }} equipos</h1>
                <a href="{{ route('admin-teams') }}" class="text-white font-light hover:text-pink-400 transition duration-500 ease-in-out">Ver equipos</a>
            </div>

            <!-- Torneos -->
            <div class="group h-44 p-5 bg-card-tournament bg-center bg-cover rounded-3xl transition duration-500 ease-in-out">
                <div class="bg-gray-400 bg-opacity-25 w-16 h-16 rounded-2xl py-3 mb-4 group-hover:bg-red-800 transition duration-500 ease-in-out">
                    <img src="{{ asset('img/icon-tournaments.png') }}" alt="" class="w-10 mx-auto">
                </div>
                <h1 class="text-white font-bold text-2xl">25 torneos</h1>
                <a href="{{ route('admin-tournaments') }}" class="text-white font-light hover:text-red-600 transition duration-500 ease-in-out">Ver torneos</a>
            </div>

            <!-- Equipos tabla -->
            <div class="lg:col-span-2 h-96 overflow-y-auto bg-card-table bg-cover bg-center rounded-3xl p-6 justify-between">
                    ...
                    <tbody>
                        @foreach ($teams2 as $team)
                            <tr class="">
                                ...
                                <td class="py-2 text-center">{{ $team->points }}</td>
