...
<body style="background-color: #1a2a41"  class="bg-register bg-cover bg-center bg-fixed">
    ...
    <div class="w-full h-full items-center">
        ...
        <div class="w-96 mx-auto text-center">
            <p class="text-white text-sm mb-4">¿Ya tienes cuenta? <a href="{{ route('login') }}" class="text-blue-400 hover:text-blue-600 transition duration-300 ease-in-out">Inicia Sesión</a></p>
        </div>
